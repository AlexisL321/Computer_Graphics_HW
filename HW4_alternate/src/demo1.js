function setup() {
    //get essential elements of canvas
    ...
    var eyeCamera = CameraCurve(viewAngle); //The position of the camera w.r.t. world coordinate
    ...
    // Create Camera (lookAt) transform
    var eyeObserver = vec3.fromValues(500,300,500); //Observer position of the camera w.r.t. camera position
	...
	console.log(tVP_PROJ_VIEW_Camera);
    }
